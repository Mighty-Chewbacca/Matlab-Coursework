...
%angleInRadians = degtorad(initialAngle); %this didnt work for some reason
...
while(xPos < wallDistance - ballRadius)
    ...
    set(handles.CPXReturn, 'String', num2str(currentX));
    set(handles.CPYReturn, 'String', num2str(currentY));
